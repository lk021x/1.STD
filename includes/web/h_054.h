#ifndef _HTML_H_054_H_
#define _HTML_H_054_H_
static const char h_054[] = {
...
"\n"
 "<script language='javascript' type='text/javascript'>\n"
 	...
 	"{\n"
 		"var URL='s_027.html?0x0750&time='+Math.random();\n"
 		"var xmlhttp;\n"
 		"if(window.XMLHttpRequest)xmlhttp=new XMLHttpRequest();\n"
 		"else xmlhttp=new ActiveXObject('Microsoft.XMLHTTP');\n"
 		"xmlhttp.onreadystatechange=function()\n"
...
"\n"
 				...
 				"{\n"
 					...
 					"for(var i=0; i<12; i++) eval('$(\\'ID_0x0'+(0x750+i).toString(16).toUpperCase()+'\\').disabled=\\'true\\';');\n"
 					"for(var i=0; i<12; i++) eval('$(\\'N'+(300+i)+'\\').disabled=true;');\n"
 				"}\n"
 				"else\n"
 				"{\n"
 					"$('trans').style.zIndex=-9999;\n"
