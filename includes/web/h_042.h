#ifndef _HTML_H_042_H_
#define _HTML_H_042_H_
static const char h_042[] = {
...
"\n"
        ...
        "{\n"
            "FromWhichDevice();\n"
            "var URL ='s_042.html?0x0000&time='+Math.random();\n"
            "var xmlhttp;\n"
...
"\n"
        ...
        "{\n"
            "var URL;\n"
            "if(type == 1){\n"
                "URL ='s_042.html?0x000'+type+'&time='+Math.random();\n"
            "}else{\n"
                "var ip=OBJ('DATE').value.split('-');\n"
                "var URL='r_042.html?'+'Y='+ip[0]+'&M='+ip[1]+'&D='+ip[2]+'&P='+1+'&time='+Math.random();\n"
            "}\n"
"\n"
            "$.ajax({\n"
                "url:URL,\n"
